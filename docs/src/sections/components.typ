...
#figure(
  ...
  table(
    ...
    [Reorder modal $=>$ Save order button], [Saves the custom order to the database], [POST (trackIds and Playlist ID], [Updates the `playlist_tracks` table with the new custom order],
